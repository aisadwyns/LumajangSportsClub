...
@section('content')
    <div class="">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('lapangan.update', $datalapangan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group my-2">
                        ...
                        <input type="text" name="nama_lapangan" id="nama_lapangan"
                            ...
                            value="{{ old('nama_lapangan', $datalapangan->nama_lapangan) }}">
                        @error('nama_lapangan')
                    ...
                    <div class="form-group my-2">
                        ...
                        <input type="text" name="jenis_lapangan" id="jenis_lapangan"
                            ...
                            value="{{ old('jenis_lapangan', $datalapangan->jenis_lapangan) }}">
                    ...
                    <div class="form-group my-2">
                        ...
                        <input type="number" step="0.01" name="harga_per_jam" id="harga_per_jam"
                            class="form-control @error('harga_per_jam') is-invalid @enderror"
                            value="{{ old('harga_per_jam', $datalapangan->harga_per_jam) }}">
                        @error('harga_per_jam')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group my-2">
                        ...
                        <textarea name="fasilitas" id="fasilitas" rows="3" class="form-control @error('fasilitas') is-invalid @enderror">{{ old('fasilitas', $datalapangan->fasilitas) }}</textarea>
                        @error('fasilitas')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
