...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="card-title">Tambah Data Komunitas</h4>
                ...
                <div class="row">
                    <div class="col-md-6 form-group my-2">
                        ...
                        <select id="jenis_komunitas_id" name="jenis_komunitas_id"
                            ...
                            @foreach ($jenis as $j)
                                <option value="{{ $j->id }}"
                                    {{ old('jenis_komunitas_id') == $j->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12 form-group my-2">
                        ...
                        <input type="text" id="link_wa" name="link_wa"
                            class="form-control @error('link_wa') is-invalid @enderror" value="{{ old('link_wa') }}">
                        @error('link_wa')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
